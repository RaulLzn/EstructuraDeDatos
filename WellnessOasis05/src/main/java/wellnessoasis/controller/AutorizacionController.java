package wellnessoasis.controller;
...
import wellnessoasis.model.repository.RegistroExamenRepository;
...
public class AutorizacionController {
    ...
    public void autorizarExamen() {
        ...
        registroExamenRepository.eliminarExamen(registroExamenRepository.buscarExamen(examen.getRadicadoExamen()));
